...
class CircleImageView : ImageView {
    ...
    fun setCirclrBgColor(bgColor: Int) {
        if (bgColor == mBgColor) {
            return
        }
    ...
    companion object {
        ...
        private val DEFAULT_BORDER_COLOR = R.color.color_translucent

        private val DEFAULT_BG_COLOR = 0x00000000
    }
}
