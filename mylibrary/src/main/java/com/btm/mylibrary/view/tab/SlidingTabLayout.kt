package com.btm.mylibrary.view.tab
...
import com.btm.mylibrary.R
import com.btm.mylibrary.view.tab.listener.OnTabSelectListener
import com.btm.mylibrary.view.tab.utils.UnreadMsgUtils.show
import com.btm.mylibrary.view.tab.widget.MsgView
import java.util.*
...
class SlidingTabLayout @JvmOverloads constructor(
    ...
    private fun obtainAttributes(
        ...
        mIndicatorStyle = ta.getInt(
            R.styleable.SlidingTabLayout_tl_indicator_style,
            STYLE_NORMAL
        )
        ...
        mIndicatorCornerRadius = ta.getDimension(
            ...
            dp2px(if (mIndicatorStyle == STYLE_BLOCK) (-1).toFloat() else 0.toFloat()).toFloat()
        )
        ...
        indicatorMarginTop = ta.getDimension(
            ...
            dp2px(if (mIndicatorStyle == STYLE_BLOCK) 7F else 0.toFloat()).toFloat()
        )
        ...
        mUnderlineHeight =
            ta.getDimension(R.styleable.SlidingTabLayout_tl_underline_height, dp2px(0f).toFloat())
        mUnderlineGravity =
        ...
        mDividerWidth =
            ta.getDimension(R.styleable.SlidingTabLayout_tl_divider_width, dp2px(0f).toFloat())
        mDividerPadding =
            ta.getDimension(R.styleable.SlidingTabLayout_tl_divider_padding, dp2px(12f).toFloat())
        ...
        mTextBold = ta.getInt(
            R.styleable.SlidingTabLayout_tl_textBold,
            TEXT_BOLD_NONE
        )
    ...
    fun setViewPager(vp: ViewPager?, titles: Array<String?>?) {
        ...
        mViewPager = vp
        mTitles = ArrayList()
        Collections.addAll<String>(mTitles, *titles)
        mViewPager!!.removeOnPageChangeListener(this)
        mViewPager!!.addOnPageChangeListener(this)
        notifyDataSetChanged()
    }
    ...
    fun setViewPager(
        ...
        check(!(titles == null || titles.size == 0)) { "Titles can not be EMPTY !" }
        mViewPager = vp
        mViewPager!!.adapter = InnerPagerAdapter(
    ...
    fun notifyDataSetChanged() {
        ...
        for (i in 0 until tabCount) {
            ...
            val pageTitle =
                if (mTitles == null) mViewPager!!.adapter!!.getPageTitle(i) else mTitles!![i]
    ...
    fun addNewTab(title: String) {
        val tabView =
            View.inflate(mContext, R.layout.layout_tab, null)
        if (mTitles != null) {
            mTitles!!.add(title)
        }
        val pageTitle =
            if (mTitles == null) mViewPager!!.adapter!!
                .getPageTitle(tabCount) else mTitles!![tabCount]
    ...
    private fun addTab(
        ...
        val tv_tab_title =
            tabView.findViewById<View>(R.id.tv_tab_title) as TextView
    ...
    private fun updateTabStyles() {
        for (i in 0 until tabCount) {
            ...
            val tv_tab_title =
                v.findViewById<View>(R.id.tv_tab_title) as TextView
            if (tv_tab_title != null) {
    ...
    private fun scrollToCurrentTab() {
        ...
        val offset =
            (mCurrentPositionOffset * mTabsContainer.getChildAt(mCurrentTab).width).toInt()
    ...
    private fun calcIndicatorRect() {
        ...
        if (mIndicatorStyle == STYLE_NORMAL && mIndicatorWidthEqualTitle) {
            val tab_title =
                currentTabView.findViewById<View>(R.id.tv_tab_title) as TextView
        ...
        if (mCurrentTab < tabCount - 1) {
            ...
            if (mIndicatorStyle == STYLE_NORMAL && mIndicatorWidthEqualTitle) {
                val next_tab_title =
                    nextTabView.findViewById<View>(R.id.tv_tab_title) as TextView
                mTextPaint.textSize = mTextsize
                val nextTextWidth =
                    mTextPaint.measureText(next_tab_title.text.toString())
